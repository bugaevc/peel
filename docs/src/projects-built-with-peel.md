# Projects Built with peel

The following are some of the projects built using peel. Their source code
might be useful as a reference:

* [Monday Night Net](https://github.com/talisein/mnn)
* [Yume 2kki Launcher](https://gitlab.com/Z-ixel/yume-2kki-launcher)
* [Simply Foxy](https://github.com/garaevdi/simply-foxy)
