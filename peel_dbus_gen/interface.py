...
class Interface:
    ...
    def generate_cpp(self, generated_header_name, skip_preambule):
        ...
        l.extend([
            ...
            '',
            'static void',
            '{}_proxy_init (GTypeInstance *self, gpointer)'.format(self.emit_name),
            '{',
            '  ::GDBusProxy *proxy = G_DBUS_PROXY (self);',
            '  g_dbus_proxy_set_interface_info (proxy, const_cast<::GDBusInterfaceInfo *> (&{}_interface_info));'.format(self.emit_name),
            '}',
            '',
            '::peel::GObject::Type',
            ...
            '        {}_proxy_init,'.format(self.emit_name),
