...
class Interface:
    ...
    def generate_header(self):
        ...
        l.extend([
            ...
            '  peel_nothrow',
            '  unsigned',
            '  export_on_bus (::peel::Gio::DBusConnection *connection, const char *object_path, ::peel::UniquePtr<::peel::GLib::Error> *error);',
            '',
        ])
        ...
        l.extend([
            ...
            '    AsyncReadyCallback &&callback, ::peel::Gio::DBusProxy::Flags flags = ::peel::Gio::DBusProxy::Flags::NONE, ::peel::Gio::Cancellable *cancellable = nullptr)',
            '  {',
            ...
            '  create_finish (::peel::Gio::AsyncResult *res, ::peel::UniquePtr<::peel::GLib::Error> *error)',
            '  {',
            ...
            '    ::peel::Gio::DBusProxy::Flags flags = ::peel::Gio::DBusProxy::Flags::NONE, ::peel::Gio::Cancellable *cancellable = nullptr)',
            '  {',
            '    ::GError *_peel_error = nullptr;',
    ...
    def generate_cpp(self, generated_header_name):
        ...
        l.extend([
            ...
            '',
            '::peel::GObject::Type',
            '{}::_peel_get_type ()'.format(self.emit_name),
            '{',
        ...
        l.extend([
            ...
            '',
            '::peel::GObject::Type',
            '{}::Proxy::_peel_get_type ()'.format(self.emit_name),
            '{',
